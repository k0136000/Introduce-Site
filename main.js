...
let transEng=["ENGLISH","Introduce","MIN GYU","Server","Daegu","Real Madrid","Experience","3Dprinter","Fusion360","Python","Arduino","More information..","Copyright MIN GYU All rights reserved."];

function translate(){
  if(transBtn.innerHTML==="ENGLISH"){
   for(let i of txtId){
